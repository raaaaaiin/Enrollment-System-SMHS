...
Public Class EditForm
    ...
    Private Sub Button2_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Dim slapublicorprivate As String = ""
        If CheckBox1.Checked = True Then
            slapublicorprivate = "Private"
        End If
        If CheckBox2.Checked = True Then
            slapublicorprivate = "Public"
        ...
        Dim sla As String = TextBox35.Text
        Dim sql As String
        If slapublicorprivate = "Public" Then
            Voucher = "17,000"
        ElseIf slapublicorprivate = "Private" Then
            Voucher = "14,000"
        End If
        sql = "UPDATE tbl_infos SET lrn = '" + Lrn + "', lastname = '" + LastName + "', firstname = '" + FirstName + "', middlename = '" + MiddleName + "', suffix = '" + Suffix + "', dobd = '" + Dobb + "', dobm = '" + Dobm + "', doby = '" + Doby + "', placeofbirth = '" + Pob + "', religion = '" + Rel + "', sex = '" + Sex + "', nationality = '" + Natio + "', civilstatus = '" + Status + "', currentaddress = '" + Address + "', mobileno = '" + Mobile + "', phoneno = '" + Phone + "', emailaddress = '" + Emailadd + "', facebookaccount = '" + Facebookacc + "', fathersname = '" + FatherN + "', foccupation = '" + FOccup + "', fcontact = '" + FCont + "', mothersname = '" + MName + "', moccupation = '" + MOccup + "', mcontact = '" + Mcont + "', guardianssname = '" + GName + "', goccupation = '" + GOccup + "', grelationship = '" + Grelation + "', gmobile = '" + Gmobile + "', gphone = '" + Gphone + "', gemailadd = '" + GEmail + "', ghomeaddress = '" + GAddress + "', siblingb5 = '" + SiblingB5 + "', sibling512 = '" + Sibling512 + "', sibling1316 = '" + Sibling1316 + "', schoollastattended = '" + sla + "', yearattended = '" + ya + "', slaaddress = '" + slaadd + "', slapublicorprivate = '" + slapublicorprivate + "', Voucher = '" + voucher + "' where Fullname = '" + Fname + "'"
