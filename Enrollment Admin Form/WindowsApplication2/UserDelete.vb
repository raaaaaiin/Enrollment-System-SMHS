...
Public Class UserDelete
    ...
    Private Sub UserDelete_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Select Case MsgBox("You're About to delete Student Record of " + Fname, MsgBoxStyle.YesNo, "Delete Record")
            Case MsgBoxResult.Yes
                Dim sql As String
                sql = "DELETE FROM tbl_infos WHERE fullname = '" + Fname + "';"
                SQLCOM = New MySqlCommand(sql, SQLCON)
                SQLREAD = SQLCOM.ExecuteReader
                MessageBox.Show(Fname + " Has been successfully deleted", "User Delete", MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
                Me.Close()
                Main.Show()
